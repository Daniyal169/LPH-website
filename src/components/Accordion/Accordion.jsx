            ...
            <div className="accordionCont">
                <div className="mx-auto max-w-7xl" data-aos="fade-up">
                    ...
                    <div className="accordion-item">
                        <button
                            className="accordion-toggle group inline-flex items-center justify-between text-left text-lg font-normal leading-8 text-gray-100 w-full transition duration-500 hover:text-red-600"
                            onClick={() => toggleAccordion(0)}
                        >
                            <h5>What type of projects do you take on?</h5>
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 0 ? 'hidden' : 'block'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 0 ? 'block' : 'hidden'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                        ...
                        {openIndex === 0 && (
                            ...
                            >
                                <p className="text-base text-gray-100 font-normal leading-6">
                    ...
                    <div className="accordion-item">
                        ...
                        >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 1 ? 'hidden' : 'block'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 1 ? 'block' : 'hidden'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                    ...
                    <div className="accordion-item">
                        ...
                        >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 2 ? 'hidden' : 'block'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 2 ? 'block' : 'hidden'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                    ...
                    <div className="accordion-item">
                        ...
                        >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 3 ? 'hidden' : 'block'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 3 ? 'block' : 'hidden'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                    ...
                    <div className="accordion-item">
                        ...
                        >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 4 ? 'hidden' : 'block'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 4 ? 'block' : 'hidden'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                    ...
                    <div className="accordion-item">
                        ...
                        >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 5 ? 'hidden' : 'block'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                className={`w-6 h-6 text-gray-100 transition duration-500 ${openIndex === 5 ? 'block' : 'hidden'} group-hover:text-red-600`}
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
